...
Bot3::Bot3(b2World *world, sf::Shape *shape)
    : PhysicalEntity(ColliderFactory::create<ItemType::Entity>(world, { shape }), { 5, 30 },
                     std::make_unique<SnowBallGun>(this, world, 55.f)),
...
void Bot3::setValue(const float value)
{
...
void Bot3::shootingScript(float deltatime)
{
